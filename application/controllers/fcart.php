...
class Fcart extends CI_Controller{
    ...
    public function paymentcart(){
        ...
        if($this->form_validation->run()){
           ...
           // $product2 = $this->mproducts->get_a_record2_product();     
           // $customer2 = $this->mcart->get_a_record2_customer();  

           // $dataOrder = array(
                //'id_kh'   => $customer2['id_kh'],
                //'id_sp' => $product2['id_sp'],
                //'ten_sp'  => $product2['ten_sp'],
                //'gia_sp'  => $product2['gia_sp'],
                //'so_luong' => $row['qty'],
                //'thoi_gian_dh' => date('Y-m-d h:i:s')
           //  );    
          // $this->mcart->addOrder($dataOrder);
